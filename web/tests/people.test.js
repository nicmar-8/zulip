...
test_people("basics", () => {
    ...
    assert.deepEqual(people.get_realm_active_human_users(), [me]);

    let realm_humans = people.get_realm_active_human_users();
    assert.equal(realm_humans[0].full_name, "Me Myself");

    realm_humans = people.get_realm_active_human_users();
    ...
    // get_realm_active_human_users() will EXCLUDE our active bot
    assert.deepEqual(
        people
...
test_people("check_active_non_active_users", () => {
    ...
    let active_humans = people.get_realm_active_human_users();
    assert.equal(active_humans.length, 2);
    ...
    active_humans = people.get_realm_active_human_users();
...
test_people("filtered_humans", () => {
    ...
    const humans = people.get_realm_active_human_users();
    const search_term = "b";
